            ...
            success  : function(res) {
                if (res.found) {
                    ...
                    $.each(res.carts, function() {
                        ...
                        html_carts += '<a title="{l s='View this cart' mod='jxoneclickorder'}" class="fancybox btn btn-default" href="index.php?tab=AdminCarts&id_cart=' + this.id_cart + '&viewcart&token={getAdminToken tab='AdminCarts'}&liteDisplaying=1#"><i class="icon-search"></i>&nbsp;{l s='Details' mod='jxoneclickorder'}</a>';
                    ...
                    $.each(res.orders, function() {
                        ...
                        html_orders += '<a href="{$link->getAdminLink('AdminOrders')|escape:'htmlall':'UTF-8'}&id_order=' + this.id_order + '&vieworder&liteDisplaying=1#" title="{l s='View this order' mod='jxoneclickorder'}" class="fancybox btn btn-default"><i class="icon-search"></i>&nbsp;{l s='Details' mod='jxoneclickorder'}</a>';
                ...
                if (res.found) {
                    ...
                    $.each(res.products, function() {
                        ...
                        if (this.customizable == '1' || this.customizable == '2') {
                            customization_html += '<div class="bootstrap"><div class="panel"><div class="panel-heading">{l s='Customization' mod='jxoneclickorder'}</div><form id="customization_' + id_product + '" class="id_customization" method="post" enctype="multipart/form-data" action="' + admin_cart_link + '" style="display:none;">';
