...
class Jxoneclickorder extends Module
{
    ...
    {
        $this->context->smarty->assign(['field' => $field]);
    ...
    public function renderTemplateFieldSettings()
    {
        ...
        return $helper->generateForm([$this->getConfigTemplateFieldSettings()]);
    }
     ...
     */
    protected function createCart($products = [])
    {
        $cart = new Cart();
     ...
     */
    public function createPreorder($customer = false, $id_cart = false, $products = [])
    {
        if (!$id_cart) {
     ...
     */
    public function renderPreorderForm()
    {
        $fields = $this->repository->getTemplateFields();
    ...
    public function hookHeader()
    {
        ...
        $this->context->controller->registerJavascript('modules-jxoneclickorder', "modules/{$this->name}/views/js/jxoneclickorder.js", ['position' => 'bottom']);
