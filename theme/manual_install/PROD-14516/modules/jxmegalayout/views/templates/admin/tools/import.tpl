          ...
          <div class="col-sm-12">
            ...
            <div class="dummyfile input-group">
              ...
              <span class="input-group-btn">
                <button id="selectLayoutArchive" type="button" name="submitAddAttachments" class="btn btn-default">{l s='Add file' mod='jxmegalayout'}</button>
              </span>
            </div>
          </div>
        </div>
        <p class="help-block text-center">
          {l s='Browse your computer files and select the Zip file for your layout.' mod='jxmegalayout'}<br>
          {l s='Maximum file size:' mod='jxmegalayout'}{$max_file_size|escape:'htmlall':'UTF-8'}.<br>
