...
<div class="col sortable {$class|escape:'html':'UTF-8'} {$elem.id_unique|escape:'html':'UTF-8'}"
     {if $preview == false}
      data-type="col"
      ...
      data-col="{$elem.col|escape:'html':'UTF-8'}"
      data-col-xs="{$elem.col_xs|escape:'html':'UTF-8'}"
      data-col-sm="{$elem.col_sm|escape:'html':'UTF-8'}"
      data-col-md="{$elem.col_md|escape:'html':'UTF-8'}"
      data-col-lg="{$elem.col_lg|escape:'html':'UTF-8'}"
      data-col-xl="{$elem.col_xl|escape:'html':'UTF-8'}"
      data-col-xxl="{$elem.col_xxl|escape:'html':'UTF-8'}"
      data-id-unique="{$elem.id_unique|escape:'html':'UTF-8'}"
     {/if}>
  <article class="col-inner clearfix inner">
    {if $preview == false}
      <div class="button-container clearfix">
        <span class="element-name">{l s='Column' mod='jxmegalayout'}
        ...
        <div class="dropdown button-container pull-right">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu-{$elem.id_unique|escape:'html':'UTF-8'}">
            <li><a href="#" class="add-row">+ {l s='Add row' mod='jxmegalayout'}</a></li>
            <li><a href="#" class="add-module">+ {l s='Add Module' mod='jxmegalayout'}</a></li>
            <li><a href="#" class="add-extra-content">+ {l s='Add Extra content' mod='jxmegalayout'}</a></li>
            <li class="divider" role="separator"></li>
            <li><a href="#" class="edit-column">{l s='Edit column' mod='jxmegalayout'}</a></li>
