...
<div class="compare-header"
  ...
  <a href="#" class="compare-products"><i class="fa fa-clone right-space" aria-hidden="true"></i><span>{l s="Compare" mod="jxcompareproduct"}(</span><span class="compare-counter"></span><span>)</span></a>
</div>
