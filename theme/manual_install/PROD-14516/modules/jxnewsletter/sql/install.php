...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'jxnewsletter` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'jxnewsletter_settings` (
    `id_jxnewsletter` int(11) NOT NULL AUTO_INCREMENT,
    `id_shop` int(11) NOT NULL,
...
$sql[] = 'INSERT INTO '._DB_PREFIX_.'jxnewsletter_settings (id_shop, is_guest, verification, timeout, ft_delay, status)
        VALUE
        ('.Context::getContext()->shop->id.', 0, 0, 1, 0.25, 1),
        ('.Context::getContext()->shop->id.', 1, 0, 1, 0.25, 1)';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'jxnewsletter_settings_lang` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `id_jxnewsletter` int(11) NOT NULL,
...
foreach (Language::getLanguages(false) as $lang) {
    $sql[] = 'INSERT INTO '._DB_PREFIX_.'jxnewsletter_settings_lang (id_jxnewsletter, id_lang, title, content)
        VALUE
