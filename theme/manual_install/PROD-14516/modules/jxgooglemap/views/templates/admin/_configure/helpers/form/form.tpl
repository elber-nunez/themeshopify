  ...
  {if $input.type == 'filemanager_image'}
    <div class="col-lg-6">
      <div class="input-group">
        <a href="filemanager/dialog.php?type=1&field_id={$input.name|escape:'htmlall':'UTF-8'}" data-input-name="{$input.name|escape:'htmlall':'UTF-8'}" type="button" id="jxgooglemap-iframe-btn" class="iframe-btn">
          <input type="text" id="{$input.name|escape:'htmlall':'UTF-8'}" class="form-control jxgooglemap-input" name="{$input.name|escape:'htmlall':'UTF-8'}" value="{if isset($fields_value[$input.name])}{if $fields_value['id_tab'] == true}{$base_url|escape:'htmlall':'UTF-8'}{/if}{$fields_value[$input.name]|escape:'htmlall':'UTF-8'}{/if}" readonly/>
