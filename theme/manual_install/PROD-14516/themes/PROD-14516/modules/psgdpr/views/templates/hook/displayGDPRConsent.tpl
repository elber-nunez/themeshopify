...
<div id="gdpr_consent" class="gdpr_module_{$psgdpr_id_module|escape:'htmlall':'UTF-8'} mb-2">
    <span class="custom-control custom-checkbox">
        <label class="psgdpr_consent_message mb-0">
            <input id="psgdpr_consent_checkbox_{$psgdpr_id_module|escape:'htmlall':'UTF-8'}" class="custom-control-input" name="psgdpr_consent_checkbox" type="checkbox" value="1">
            <span class="custom-control-label">{$psgdpr_consent_message nofilter}</span>{* html data *}
        </label>
    </span>
</div>
{literal}
