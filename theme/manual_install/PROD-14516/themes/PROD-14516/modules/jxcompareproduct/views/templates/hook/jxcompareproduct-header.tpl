...
<div id="_desktop_compare">
  <div class="compare-header"
    ...
    <a href="#" class="compare-products"><i class="linearicons-compare" aria-hidden="true"></i><span>{l s='Compare' mod='jxcompareproduct'}(</span><span class="compare-counter"></span><span>)</span></a>
  </div>
</div>
