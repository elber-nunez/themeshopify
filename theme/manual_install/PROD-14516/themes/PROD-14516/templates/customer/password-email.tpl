  ...
  <form action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <section class="form-fields">
      <div class="form-group center-email-fields">
        <div class="email">
          <input type="email" name="email" id="email" value="{if isset($smarty.post.email)}{$smarty.post.email|stripslashes}{/if}" placeholder="{l s='Email address' d='Shop.Forms.Labels'}" class="form-control" required>
        </div>
      </div>
    </section>
